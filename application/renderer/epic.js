...
function renderApps() {
  ...
  if (filtered.length === 0) {
    appsContainer.innerHTML = "<p>No se encontraron juegos de Epic Games instalados.</p>";
    return;
  }
  ...
  filtered.forEach((app, index) => {
      ...
      icon.onerror = () => { icon.src = "../assets/icons/epic-games.svg"; icon.style.padding = "20px"; icon.style.background = "#2a2a2a"; };
